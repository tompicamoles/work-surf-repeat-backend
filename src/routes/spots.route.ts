...
import { CreateSpotDto, CreateSpotLikeDto } from '@dtos/spots.dto';
...
export class SpotRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}/:id(\\d+)/like`, ValidationMiddleware(CreateSpotLikeDto), AuthMiddleware, this.spot.addSpotLike);
